...
impl LiveOrderBookMessage {
    pub fn new(symbol: String, bids: VecDeque<(u64, f64)>, asks: VecDeque<(u64, f64)>) -> Self {
        Self { symbol, bids, asks }
    }
...
impl OrderBook {
    ...
    pub fn get_bids(&self) -> &BTreeMap<u64, f64> {
        &self.bids
    }

    pub fn get_asks(&self) -> &BTreeMap<u64, f64> {
        &self.asks
    }
}
